...
describe('exactExecutionBuilder', () => {
  ...
  it('should create a caveat with a valid exact execution', () => {
    const caveat = exactExecutionBuilder(mockEnvironment, testTo, testValue, testData);
  ...
  it('should throw an error if to is not an address', () => {
    const testToOverride = '0x12345678901234567890123456789012345678901234123412341234'; // longer than 42 chars

    expect(() => {
      exactExecutionBuilder(mockEnvironment, testToOverride, testValue, testData);
  ...
  it('should throw an error if value is not positive', () => {
    ...
    expect(() => {
      exactExecutionBuilder(mockEnvironment, testTo, testValueOverride, testData);
